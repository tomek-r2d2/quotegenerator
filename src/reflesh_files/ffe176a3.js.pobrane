(function () {
  var typefaces = [];
    ...
    typefaces.push({
      familyName: 'proxima-nova-sc',
      className: 'proxima-nova-sc',
      weight: '300',
      style: 'normal'
    });
  ...
  window.FortAwesomeConfig = {
    ...
    useUrl: 'use.fortawesome.com/kits/ffe176a3/publications/58932',
    code: 'ffe176a3',
    familyName: 'FontAwesomeSite',
    prefix: 'fas',
    testString: '\u0026',
    typefaces: typefaces
  };
